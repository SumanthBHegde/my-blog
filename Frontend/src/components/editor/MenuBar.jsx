...
const MenuBar = ({ editor }) => {
  ...
  return (
    // Render menu bar with modern forest-themed styling
    <div className="border-2 border-forest-200 rounded-xl p-4 sticky top-3 left-0 right-0 bg-gradient-to-br from-white to-forest-50/30 backdrop-blur-sm z-10 flex gap-1.5 flex-wrap shadow-lg shadow-forest-100/50">
      {/* Text Formatting Section */}
      <div className="flex gap-1 items-center border-r border-forest-200 pr-2">
        {/* Button for H1 heading */}
        <button
          onClick={() =>
