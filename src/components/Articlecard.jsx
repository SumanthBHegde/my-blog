      ...
      <div className='p-5'>
        ...
        <div className="flex justify-between flex-nowrap mt-6 items-center">
            <div className="flex items-center gap-x-2 md:gap-x-2.5">
                <img src={images.PostProfileImage} alt="profile pic" className="w-9 h-9 md:w-10 md:h-10"/>
                <div className="flex flex-col">
                    <h4 className="font-bold italic text-dark-soft text-sm md:text-base">Sumukha B.K</h4>
                    <div className="flex items-center gap-x-2">
                        <span className="bg-primary w-fit bg-opacity-20 p-1.5 rounded-full">
                            <BsCheckLg className="w-1.5 h-1.5 text-primary"/>
                        </span>
